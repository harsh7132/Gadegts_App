...
import 'package:gadgets/lenovo_laptops.dart';
import 'package:gadgets/msi_laptops.dart';
...
class Msi_page extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          child: Container(
            child: Column(
              children: [
                ...
                Text(
                  'Click Here To See Best Laptops From Lenovo',
